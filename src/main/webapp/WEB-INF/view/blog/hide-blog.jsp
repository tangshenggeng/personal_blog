			...
			<div class="layui-col-md12">
				<div class="card">
					<div class="card-header">
						...
						<button class="layui-btn " type="button" id="exceptionCustBtn"><i class="layui-icon layui-icon-video"></i>展示选中</button>
					</div>
					<div class="card-body">
		...
		<div class="panel panel-default">
		  <div class="panel-body" >
		  	<form class="layui-form">
				  ...
				  <div class="layui-input-block">
				  	<input type="radio" name="blogState" value="展示" title="展示" >
      				<input type="radio" name="blogState" value="隐藏" title="隐藏" checked>
				  </div>
				</div>
		  		<div class="layui-form-item">
				    <div class="layui-input-block">
