			...
			<div class="layui-col-md12">
				<div class="card">
					<div class="card-header">
						...
						<button class="layui-btn " type="button" id="exceptionCustBtn"><i class="layui-icon layui-icon-face-surprised"></i>选中恢复</button>
					</div>
					<div class="card-body">
...
function renderTb() {
	...
	layui.use(['table','util'], function() {
		...
		table.render({
			elem : '#dataListTb',
			height :400,
			url : '${PATH}/integralRecharge/getAbnormalList',
			id:"datListTbId",
			size : 'sm ',
...
$("#exceptionCustBtn").click(function(){
	layui.use(['table','layer'], function() {
		var table = layui.table
		,layer = layui.layer;
		layer.confirm('确认恢复该充值订单吗？', function(index){
			var checkStatus = table.checkStatus('dataListTbId');
			var datas = checkStatus.data
			var ids = new Array();
			$(datas).each(function(){
			...
			$.ajax({
				url:"${PATH}/integralRecharge/recoveryByIds",
				method:"POST",
				contentType: "application/json",//必须指定，否则会报415错误
			    dataType : 'json',
				data:JSON.stringify(ids),
